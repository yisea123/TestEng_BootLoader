...
void init(void)
{
    ...
    /*SPI pins*/
    Disable_spi_en();
    /*isamp 1 to 16 mux enable*/
    Disable_m_en1();
    /*isamp 17 to 32 mux enable*/
    Disable_m_en2();
    /*mpd 1 to 16 mux enable*/
    Disable_m_en3();
    /*mpd 17 to 32 mux enable*/
    Disable_m_en4();
    /*vsamp 1 to 16 mux enable*/
    Disable_m_en5();
    /*vsamp 17 to 32 mux enable*/
    Disable_m_en6();
    ...
    Set_spi_cs_n(SPI_CS_NONE);
    Choose_MUX_Channel(0);

    /*init max5478 to max resistor*/
    MAX5478_init();
    Max7312_init();
    LTC2620_init();
    AD7949_init();
...
{    
    ...
    RCC_APB1PeriphClockCmd(RCC_APB1Periph_SPI2 | RCC_APB1Periph_I2C1 |
