...
#define BOOTAPP_APP_GPIO_NUM 12
...
extern void GPIO_WriteBit(BootApp_GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin, uint8_t BitVal);
extern uint8_t GPIO_ReadInputDataBit(BootApp_GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin);
#endif
