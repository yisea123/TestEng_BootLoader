...
void GPIO_WriteBit(BootApp_GPIO_TypeDef* GPIO_TypeDef, uint16_t GPIO_Pin, uint8_t BitVal)
{
    (void)*GPIO_TypeDef;
    (void)GPIO_Pin;
    (void)BitVal;
}
uint8_t GPIO_ReadInputDataBit(BootApp_GPIO_TypeDef* GPIO_TypeDef, uint16_t GPIO_Pin)
{
    (void)*GPIO_TypeDef;
    (void)GPIO_Pin;
    return 1;
